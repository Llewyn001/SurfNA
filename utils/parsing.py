...
def parse_train_args():
    ...
    # mdn mode
    parser.add_argument('--model_type',  type=str, default='score_model', help='model type',choices=['score_model','mdn_model','pretrain_model','energy_score_model','surface_score_model'])
